      ...
      <div className=" navBar ">
        <ul className=" me-4 mb-2 h-100 d-flex flex-md-column align-items-end justify-content-center ">
          <li className="  my-2 mx-1   ">
            <NavLink
              to=""
              className="d-flex nav-mid-shadow  nav-text rounded-5 justify-content-center align-items-center "
            >
          ...
          <li className="  my-2 mx-1   ">
            <NavLink
              to="about"
              className="d-flex nav-text rounded-5 nav-mid-shadow  justify-content-center align-items-center "
            >
