...
export default function NavBar() {
  return (
    <>
      <div className=" position-fixed z-3  top-0 bottom-0 end-0">
        <ul className=" me-4 vh-100 d-flex  align-items-end justify-content-center flex-column">
          <li className="  my-2 shadow  ">
            <NavLink
              to="/"
            ...
            >
              ...
              <div className="nav-ic d-flex rounded-circle justify-content-center align-items-center">
