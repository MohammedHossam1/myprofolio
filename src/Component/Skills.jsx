    ...
    <div className="skills py-5">
      <div className=" my-5">
        ...
        <div className="row d-flex justify-content-center w-100">
          <div className="col-md-2  d-flex justify-content-center flex-column align-items-center">
          ...
          <div className="col-md-2  d-flex justify-content-center flex-column align-items-center">
            <div className="border m-1 rounded-2">
              <img src={bootstrapIc} className="w-100" alt="" />
            </div>
            <h2>BOOTSTRAB</h2>
          </div>
          <div className="col-md-2  d-flex justify-content-center flex-column align-items-center">
            <div className="border m-1 rounded-2">
              <img src={reactIc} className="w-100 rounded-5" alt="" />
            </div>
            <h2>REACT JS</h2>
          </div>
        </div>
        <div className="row d-flex justify-content-center w-100">
          <div className="col-md-2  d-flex justify-content-center flex-column align-items-center">
            <div className="border m-1 rounded-2">
              <img src={nextIc} className="w-100" alt="" />
            </div>
            <h2>NEXT JS</h2>
          </div>
          <div className="col-md-2  d-flex justify-content-center flex-column align-items-center">
            <div className="border m-1 rounded-2">
              <img src={jqIc} className="w-100" alt="" />
          ...
          <div className="col-md-2  d-flex justify-content-center flex-column align-items-center">
            <div className="border m-1 rounded-2">
              <img src={github} className="w-100" alt="" />
            </div>
            <h2>GIT/GITHUB</h2>
          </div>
          <div className="col-md-2  d-flex justify-content-center flex-column align-items-center">
            <div className="border m-1 rounded-2">
              <img src={tsIc} className="w-100" alt="" />
            </div>
            <h2>TYPESCRIPT</h2>
          </div>
          <div className="col-md-2  d-flex justify-content-center flex-column align-items-center">
            <div className="border m-1 rounded-2">
              <img src={sassIc} className="w-100" alt="" />
            </div>
            <h2>SASS</h2>
