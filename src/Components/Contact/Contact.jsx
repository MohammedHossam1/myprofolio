  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="text-sm">صعب ان كل شويه اكتب رساله ع الموقع  
          -مش هقول كنت شاكك ف مين اكيد 
          - ممكن تقول نت مين وياصابت يا خابت مفيهاش حاجه ان شاء الله
        -ويعني اي مش هستفاد حاجه 
        اعمل حساب وهمي علي الفيس ارحم وابعتلي 
